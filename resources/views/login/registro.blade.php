            ...
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                <div class="card mb-3" style="max-width: 1040px; background: transparent;">
                    ...
                    <div class="col-md">
                        ...
                        <h5 class="card-title text-center mt-4 fs-3"><strong>Registro</strong></h5>
                            <div class="mb-3 row">
                            ...
                            <div class="d-grid gap-2">
                                <button type="button" class="btn btn-primary border rounded-pill btn-lg">Registrar</button>
                                <a href="./login.html" class="btn btn-light border rounded-pill btn-lg">Iniciar Sesion</a>
                            </div>
                        </div>
                    </div>
                    </div>
